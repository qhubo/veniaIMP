...
<?php echo '</form>'; ?>
<?php  include_partial('actualiza_inventario_ubica/detalle', array('pere'=>$pere, 'bodega'=>$bodega, 'modulo'=>$modulo,  'forma'=>$forma,  'muestrabusqueda' => $muestrabusqueda, 'bodegaId' => $bodegaId, 'linea' => $linea, 'productos' => $productos)) ?>
