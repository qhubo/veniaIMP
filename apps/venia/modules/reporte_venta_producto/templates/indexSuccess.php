    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title kt-font-info">
                REPORTE DE VENTA DE PRODUCTOS <small> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>  </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Filtra por rangos de fechas
                </small>
            </h3>
        </div>
...
<?php echo $form->renderHiddenFields() ?>
        ...
        <div class="row" style="padding-top:10px;">
                <div class="col-lg-1 control-label right "> Bodega </div>
                <div class="col-lg-2 <?php if ($form['bodega']->hasError()) echo "has-error" ?>">
                    ...
                    <div class="col-lg-1 control-label right ">Producto </div>
        ...
        <div class="row" style="padding-top:10px;">
                ...
                <div class="col-lg-4 <?php if ($form['cliente']->hasError()) echo "has-error" ?>">
