...
<div class="kt-portlet kt-portlet--responsive-mobile">
    ...
    <div class="kt-portlet__body">
        ...
        <div class="row">
            ...
            <label class="col-lg-2 control-label">Nombre:<span class="required"> * </span>                                                                   </label>
        ...
        <div class="row">
            <div class="col-lg-1"> </div>        
            <label class="col-lg-2 control-label">Descripción:<span class="required"> * </span>                                                                   </label>
        ...
        <div class="row">
            <div class="col-lg-1"> </div>        
            <label class="col-lg-2 control-label"><?php echo TipoAparatoQuery::tipo(); ?> <span class="required"> * </span> </label>
            ...
            <?php if (!$producto) { ?>
     <label class="col-lg-2 control-label">Código Sku</label>
        ...
        <div class="row">
            <div class="col-lg-1"> </div>        
            <label class="col-lg-2 control-label"><?php echo TipoAparatoQuery::marca(); ?>  </label>
            ...
            <label class="col-lg-2 control-label">Código Barras</label>
        ...
        <div class="row">
            <div class="col-lg-1"> </div>        
            <label class="col-lg-2 control-label"><?php echo TipoAparatoQuery::modelo(); ?> </label>
            <div class="col-lg-3 <?php if ($form['modelo']->hasError()) echo "has-error" ?>">
        ...
        <div class="row">
            <div class="col-lg-1"> </div>        
            <label class="col-lg-2 control-label"> Precio Venta: <span class="required"> * </span></label>
 ...
 <div class="col-lg-1 ">Costo </div>
            ...
            <div class="col-lg-2 <?php if ($form['costo']->hasError()) echo "has-error" ?>">
                <?php echo $form['costo'] ?>           
                <span class="help-block form-error"> 
...
<!--            <div class="col-lg-2 <?php if ($form['unidad_medida_costo']->hasError()) echo "has-error" ?>">
      ...
      <div class="col-lg-1 align-items-lg-center">Perecedero </div> 
            <div class="col-lg-1 <?php if ($form['tercero']->hasError()) echo "has-error" ?>">
              
                <?php echo $form['tercero'] ?>  
                <span class="help-block form-error"> 
                    <?php echo $form['tercero']->renderError() ?>  
                </span>
            </div>
