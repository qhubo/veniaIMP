...
<div class="kt-portlet kt-portlet--responsive-mobile">
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title kt-font-success"> Tranferencia / Depositos
                <small>&nbsp;&nbsp;&nbsp; Ingresa una nueva transferencia o  depósito recibido. Visualiza por un rango de fechas  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</small>
            </h3>
        </div>
    ...
    <div class="kt-portlet__body">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-lg-6"><h3>Transferencias / Depositos</h3></div>
