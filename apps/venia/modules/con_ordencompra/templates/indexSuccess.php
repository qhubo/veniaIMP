        ...
        <table class="table table-striped- table-bordered table-hover table-checkable XXdataTable no-footer dtr-inlin XXkt-datatable" id="html_table" width="100%">
            <thead >
                <tr class="active">
                    ...
                    <th  align="center"><span class="kt-font-success"> Monto </span></th>
                    ...
                    <tr <?php if ($conta % 2 == 0) { ?> style="background-color:  #F3F7FE" <?php } ?> >
                        ...
                        <td>
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <a href="<?php echo url_for("orden_compra/vista?token=" . $data->getToken()) ?>" class="btn btn-sm btn-dark" data-toggle="modal" data-target="#ajaxmodal<?php echo $data->getId(); ?>"> <li class="fa flaticon2-search"></li>    </a>
                        ...
                        <td><a href="<?php echo url_for("proceso/rechaza?tipo=ordencompra&token=" . $data->getToken()) ?>" class="btn btn-sm btn-block btn-danger" data-toggle="modal" data-target="#ajaxmodalRECHAZA<?php echo $data->getId(); ?>"> <li class="fa flaticon2-cancel"></li>    </a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
