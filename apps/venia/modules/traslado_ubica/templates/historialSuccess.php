    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title kt-font-success">
               TRASLADO DE UBICACIONES <small>   Filtra por rango de fechas  <strong>  </strong>    </small>
            </h3>
        </div>
...
<!--                        <table class="kt-datatable table-condensed flip-content" id="html_table" width="100%">-->
                <table class="table table-bordered  xdataTable table-condensed flip-content"  width="100%" >
                    <thead>
                        <tr class="info">
                            <th>Codigo </th>
                            <th>Fecha</th>
