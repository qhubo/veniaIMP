    ...
    <table style="width:740px;">
        <thead>
            <tr>
                ...
                <th  style=" font-size:25px; height:20px; font-weight: bold;width:90px;text-align: center;">Costo Total</th>
            </tr>
        </thead>
        <tbody>
            <?php $total = 0; ?>
            ...
            <tr>
                ...
                <td style="width:340px; font-size:27px;width:335px "><?php echo $regi->getProducto()->getNombre(); ?></td>
                ...
                <td style="width:90px;text-align:right;font-size:27px; "><?php echo $regi->getTienda()->getCodigo(); ?>&nbsp;<?php echo $regi->getUbicacionId(); ?></td>
                <td style="width:70px;text-align:right;font-size:27px; "><?php echo Parametro::formato(($regi->getCantidad()*$regi->getProducto()->getCostoProveedor()),false); ?></td>
