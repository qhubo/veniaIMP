    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            <span class="kt-portlet__head-icon">
                <i class="flaticon-list-1 kt-font-info"></i>
            </span>
            <h3 class="kt-portlet__head-title kt-font-danger">
                Resultado <small>   Detalle de registro     </small>
            </h3>
        </div>
      ...
      <div class="kt-portlet__body">
            ...
            <div class="col-lg-1"> </div>    
            <div class="col-lg-2" style="font-size: 18px; font-weight: bold; text-align: center;"> <?php echo $bitacora->getTipo(); ?>  </div>    

            <div class="col-lg-1 kt-font-brand">Fecha </div>    
            ...
            <table class="table table-bordered  dataTable table-condensed flip-content" id="sample_2">
                <thead class="flip-content">
                    <tr class="active">
                        ...
                        <th  align="right"> <?php if ($bitacora->getTipo()=='CambioPrecio') { ?> Precio <?php } else { ?>Costo <?php } ?> </th>
                    ...
                    <?php $lista = $data->getProducto(); ?>
                        <tr  <?php if (!$lista->getActivo()) { ?> class="warning" <?php } ?> >
                            ...
                            <td align="right">
                                ...
                                <font size="-1"> <?php echo Parametro::formato( $data->getPrecio(),false); ?></font>  
