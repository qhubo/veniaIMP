...
<div class="kt-portlet kt-portlet--responsive-mobile">
    ...
    <div class="kt-portlet__body">
        ...
        <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inlin kt-datatable" id="html_table" width="100%">
            <thead >
                <tr class="active">
                  <th  align="center"><span class="kt-font-success"> Superior </span></th>
                    <th  align="center"><span class="kt-font-success">  Nombre</span></th>
                    <th  align="center"><span class="kt-font-success"> Modulo </span></th>
            ...
            <tbody>
                <?php foreach ($registros as $data) { ?>
                    <?php $lista = $data; ?>
                <?php $super =''; ?>
                <?php $menu = MenuSeguridadQuery::create()->findOneById($data->getSuperior()); ?>
                <?php if ($menu) { $super = $menu->getDescripcion();  }  ?>
                    <tr>
                        <td><?php echo $menu; ?></td>
                        <td><?php echo $data->getDescripcion(); ?></td>
                        <td><?php echo $data->getModulo() ?></td>
