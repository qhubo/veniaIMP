...
<div class="kt-portlet kt-portlet--responsive-mobile">
    ...
    <div class="kt-portlet__body">
        <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inlin kt-datatable" id="html_table" width="100%">
            <thead >
                <tr class="active">
                    ...
                    <th  align="center"><span class="kt-font-success"> Accesos </span></th>
        ...
        <?php $menuperd= PerfilMenuQuery::create()
                ->useMenuSeguridadQuery()
                ->filterBySubMenu(true)
                ->endUse()
                ->filterByPerfilId($data->getId())
                ->find(); ?>
        
        <td>
        <ol>
            <?php foreach ($menuperd as $regi) { ?>
            <li><?php echo $regi->getMenuSeguridad()->getDescripcion(); ?> </li>
            <?php } ?>
 ...
 <a class="btn btn-warning btn-sm btn-block"  href="<?php echo url_for($modulo . '/accesos?id=' . $data->getId()) ?>" ><li class="fa fa-list-alt"></li>  Accesos &nbsp;</a> 
