...
<div class="kt-portlet kt-portlet--responsive-mobile">
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title kt-font-success"> Reporte Ventas Por Categoria
            ...
            <table class="table table-bordered  dataTable table-condensed flip-content" >
                <thead class="flip-content">
                    <tr class="info">
                        ...
                        <th  align="center">Valor Costo</th>
                ...
                <tbody>
                   ...
                   <?php  if ($registro->getProductoId()) { ?>
                        <?php $codigo = ''; ?>
                        <?php $nombre = 'N/A'; ?>
                        <?php if ($registro->getProducto()->getMarcaId()) { ?>
                            <?php $codigo = $registro->getProducto()->getMarca()->getCodigo(); ?>
                            <?php $nombre = $registro->getProducto()->getMarca()->getDescripcion(); ?>
                        <?php } ?>
                        <?php $PrecioVentas = $registro->getTotalMonto(); ?>
                        <?php $valorCosto = MarcaQuery::ValorCosto($bodegaId, $fechaInicio, $fechaFin, $registro->getProducto()->getMarcaId()); ?>
                        <?php $margen = $PrecioVentas - $valorCosto; ?>    
                        <?php $PorVenta = ($PrecioVentas / $Grantotal) * 100; ?>    
                        <?php $GP = $margen / $PrecioVentas; ?>
                        <?php $totalventa = $totalventa+$PrecioVentas; ?>
                    <?php $totalCosto =$totalCosto+$valorCosto; ?>
                        <tr>
                            <td><?php echo $registro->getOperacion()->getBodega()->getNombre(); ?></td>
                            <td><?php echo $fechaInicio . " AL " . $fechaFin ?></td>
                            <td><?php echo $codigo; ?></td>
                            <td><?php echo $nombre; ?></td>
                            <td align="right"><?php echo number_format($PrecioVentas, 2); ?></td>
                            <td align="right"><?php echo number_format($valorCosto, 2); ?></td>
                            <td align="right"><?php echo number_format($PorVenta, 2) ?>%</td>
                            <td align="right"><?php echo number_format($margen, 2); ?></td>
                            <td align="right"><?php echo number_format($GP, 2); ?></td>
                        </tr>
                    <?php } ?>
                           <?php } ?>
                ...
                <tfoot>
                <td colspan="4"></td>
                <th align="right"><div align="right"><?php echo number_format($totalventa, 2); ?></div> </th>
                            <th align="right"><div align="right"><?php echo number_format($totalCosto, 2); ?></div></th>
                                <td colspan="3"></td>
                </tfoot>
