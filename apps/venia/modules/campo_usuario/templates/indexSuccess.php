    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title kt-font-success">
                LISTADO DE <?php echo $titulo; ?><small> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>  </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Utiliza este campos para capturar
                    información adicional en cualquier documento
                </small>
            </h3>
        </div>
    ...
    <div class="kt-portlet__body">
        ...
        <thead >
                <tr class="active">
                    ...
                    <th  align="center"><span class="kt-font-success">Campo</span></th>
            ...
            <tbody>
                <?php foreach ($registros as $data) { ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $tipo[$data->getTipoDocumento()] ?></td>
           <td><?php echo $tipoc[$data->getTipoCampo()]; echo $data->getTipoCampo(); ?></td>
