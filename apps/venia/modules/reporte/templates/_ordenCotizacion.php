...
<table class="sin-borde">
    <tr>
        ...
        <td width="15%" class="borde">
            <table width="100%">
                <tr>
                    <td class="negrita" style="color:red">PEDIDO No.</td>
                </tr>
                <tr>
                    <td class="centrado titulo" style="color:red"><?php echo $orden->getCodigo(); ?></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td  style="width:65%">  
            ...
            <div class="header-left">
                ...
                <strong>Acuerdo de Pago:</strong> <?php echo $operacion->getAcuerdoPago(); ?> <BR>
...
<table>
    ...
    <tbody>
        ...
        <?php foreach ($lista as $regist) { ?>
            ...
            <?php $totalPeso = $totalPeso + ($regist->getProducto()->getPeso() *$regist->getCantidad()); ?>
