    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            <span class="kt-portlet__head-icon">
                <i class="flaticon2-copy kt-font-warning"></i>
            </span>
            <h3 class="kt-portlet__head-title kt-font-success">
                LISTADO DE FORMATOS DE CHEQUE<small> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>  </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </small>
            </h3>
        </div>
        ...
        <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inlin kt-datatable" id="html_table" width="100%">
            <thead >
                <tr class="active">
                    ...
                    <th  align="center"><span class="kt-font-success">  Título</span></th>
                    <th  align="center"><span class="kt-font-success"> Activo </span></th>
                    <th  align="center"><span class="kt-font-success"> No Actual </span></th>
                    <th>Reporte</th>
            ...
            <tbody>
                <?php foreach ($registros as $data) { ?>
                    <?php $lista = $data; ?>
                    <tr>
                        <td><?php echo $data->getBanco(); ?></td>
                        <td><?php echo $data->getTitulo() ?></td>
                        <td> <?php if ($data->getActivo()) { ?><li class="fa fa-check"></li> <?php } ?> </td>
                <td style="text-align:right"><div style="text-align:right"> <?php echo $data->getCorrelativo() ?></div> </td>
                <td>      
                    <div style="text-align:center">
                        <a target="_blank" href="<?php echo url_for('formato_cheque/reporte?id=' . $data->getId()) ?>" class="btn  btn-sm  btn-warning" > <i class="flaticon2-print"></i> Reporte </a>
                    </div>
                </td>
                <td>    
                    <div style="text-align:center">
