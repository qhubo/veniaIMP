...
<div class="kt-portlet kt-portlet--responsive-mobile">
    ...
    <div class="kt-portlet__body">
        <div class="row">
         ...
         <div class="col-lg-2 <?php if ($form['fecha_inicio']->hasError()) echo "has-error" ?>">
                <?php echo $form['fecha_inicio'] ?>           
                <span class="help-block form-error"> 
                    <?php echo $form['fecha_inicio']->renderError() ?>  
                </span>
            </div>
            <div class="col-lg-1">Tasa Interes </div>
         <div class="col-lg-2 <?php if ($form['tasa_interes']->hasError()) echo "has-error" ?>">
                <?php echo $form['tasa_interes'] ?>           
                <span class="help-block form-error"> 
                    <?php echo $form['tasa_interes']->renderError() ?>  
                </span>
            </div>
        </div>
                    <div class="row" style="padding-bottom:10px;">
            <div class="col-lg-1"> </div>
            <div class="col-lg-2">Moneda</div>
         <div class="col-lg-2 <?php if ($form['moneda']->hasError()) echo "has-error" ?>">
                <?php echo $form['moneda'] ?>           
                <span class="help-block form-error"> 
                    <?php echo $form['moneda']->renderError() ?>  
                </span>
            </div>
                    <div class="col-lg-1">Valor</div>
