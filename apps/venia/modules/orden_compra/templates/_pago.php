<div class="row">
    <Div class="col-lg-6">
        ...
        <?php echo $form->renderFormTag(url_for('orden_compra/muestra?token=' . $orden->getToken()), array('class' => 'form-horizontal"')) ?>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td style="text-align: right">
                                <strong>
                                <?php echo Parametro::formato($orden->getValorTotal()-$orden->getValorImpuesto()-$orden->getValorPagado()); ?>
                       </strong></td>
                                </tr>
                    </tfoot>
                </table>
