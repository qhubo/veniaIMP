    ...
    <div class="kt-portlet__body">
        <div class="row">
            <div class="col-lg-1"> </div>
                    ...
                    <div class="row">
            <div class="col-lg-1"> </div>
            <div class="col-lg-2">Centro Costo </div>
         <div class="col-lg-2 <?php if ($form['centro_costo']->hasError()) echo "has-error" ?>">
                <?php echo $form['centro_costo'] ?>           
                <span class="help-block form-error"> 
                    <?php echo $form['centro_costo']->renderError() ?>  
                </span>
            </div>
        </div>
