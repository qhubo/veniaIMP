...
<div class="kt-portlet kt-portlet--responsive-mobile">
    ...
    <div class="kt-portlet__body">
         ...
         <div class="col-lg-2 <?php if ($form['codigo']->hasError()) echo "has-error" ?>">
                ...
                <span class="help-block form-error"> 
                    <?php echo $form['codigo']->renderError() ?>  
                         ...
                         <div class="row"  style="padding-bottom:10px;">
            <div class="col-lg-1"> </div>
            <div class="col-lg-2">Codigo Planilla </div>
         <div class="col-lg-2 <?php if ($form['codigo_planilla']->hasError()) echo "has-error" ?>">
                <?php echo $form['codigo_planilla'] ?>           
                <span class="help-block form-error"> 
                    <?php echo $form['codigo_planilla']->renderError() ?>  
                </span>
            </div>
        </div>
        ...
        <div class="row" style="padding-bottom:8px;">
            <div class="col-lg-1"> </div>
            <div class="col-lg-2">Tienda Comisión </div>
         <div class="col-lg-4 <?php if ($form['tienda_comision']->hasError()) echo "has-error" ?>">
                <?php echo $form['tienda_comision'] ?>           
                <span class="help-block form-error"> 
                    <?php echo $form['tienda_comision']->renderError() ?>  
                </span>
            </div>
        </div>    
         ...
         <div class="col-lg-2 <?php if ($form['porcentaje_comision']->hasError()) echo "has-error" ?>">
                <?php echo $form['porcentaje_comision'] ?>           
                <span class="help-block form-error"> 
                    <?php echo $form['porcentaje_comision']->renderError() ?>  
                </span>
            </div>
        </div>        
               ...
               <div class="row" style="padding-bottom:8px;">
            <div class="col-lg-1"> </div>
            <div class="col-lg-2">Encargado Tienda </div>
         <div class="col-lg-4 <?php if ($form['encargado_tienda']->hasError()) echo "has-error" ?>">
                <?php echo $form['encargado_tienda'] ?>           
                <span class="help-block form-error"> 
                    <?php echo $form['encargado_tienda']->renderError() ?>  
                </span>
            </div>
        </div>
