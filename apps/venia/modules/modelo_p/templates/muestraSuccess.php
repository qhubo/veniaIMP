...
<div class="kt-portlet kt-portlet--responsive-mobile">
        ...
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title kt-font-brand">
                <?php if ($marca) { ?>
                    ...
                    <?php } else { ?>
                        <i class="flaticon2-plus"></i>  Nuevo Categoria    
                    <?Php } ?>
            </h3>
        </div>
    ...
    <div class="kt-portlet__body">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 <?php if ($form['marca_id']->hasError()) echo "has-error" ?>">
...
<script>
    $(document).ready(function () {
        $("#consulta_tipo_aparato_id").on('change', function () {
            //    alert('cambio');
            $("#consulta_marca_id").empty();
            $("#consulta_marca_id").empty();
            $.getJSON('<?php echo url_for("soporte/tipoMarca") ?>?id=' + $("#consulta_tipo_aparato_id").val(), function (data) {
                console.log(JSON.stringify(data));
                $.each(data, function (k, v) {
                    $("#consulta_marca_id").append("<option value=\"" + k + "\">" + v + "</option>");
                }).removeAttr("disabled");
            });
        });
    });
