    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title kt-font-success">
                    CUADRE DE INVENTARIO ACTUALIZACION  <small>      </small>
            </h3>
        </div>
        <div class="kt-portlet__head-toolbar">
            <a href="<?php echo url_for("carga/index?tipo=existencianueva") ?>" class="btn btn-secondary btn-hover-brand" data-toggle="modal" data-target="#ajaxmodal"> <li class="fa fa-cloud-download"></li> Importar archivo   </a>
        </div>
    </div>
...
<?php echo '</form>'; ?>
<?php include_partial('actualiza_tienda_ubica/detalle', array('pere'=>$pere, 'bodega'=>$bodega, 'modulo'=>$modulo,  'forma'=>$forma,  'muestrabusqueda' => $muestrabusqueda, 'bodegaId' => $bodegaId, 'linea' => $linea, 'productos' => $productos)) ?>
