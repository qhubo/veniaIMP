    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title kt-font-info">
                REPORTE DE GASTOS <small> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>  </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Filtra por rangos de fechas
                </small>
            </h3>
        </div>
...
<?php echo $form->renderHiddenFields() ?>
        ...
        <?php include_partial($modulo.'/listado', array('registros' => $registros,'registrosCaja'=>$registrosCaja)) ?>  
