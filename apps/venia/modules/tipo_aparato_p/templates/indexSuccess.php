...
<div class="kt-portlet kt-portlet--responsive-mobile">
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title kt-font-info"> Grupo<small> Listado de Grupos de Productos</small>
            </h3>
        </div>
            ...
            <table class="kt-datatable" xid="html_table" xwidth="100%">
                <thead >
                    <tr >
                        ...
                        <th width="100px" align="center"><span class="kt-font-info"> Imagen</span>  </th>
                        <th width="100px" align="center"><span class="kt-font-info"> Codigo</span>  </th>
                        <th  width="50px"  align="center"><span class="kt-font-info">Cuenta Contable</span></th>
                        ...
                        <th  width="300px" align="center"><span class="kt-font-info">Activo</span></th>
                                                      <th  width="300px" align="center"><span class="kt-font-info">Venta</span></th>
<!--                        <th  align="center"><span class="kt-font-info">Receta</span> </th>-->
                ...
                <tbody>
                    ...
                    <?Php $lista  =$registro; ?>
                        <tr>
                            <td><?php if ($registro->getImagen()) { ?> <img src="<?php echo $registro->getImagen() ?>"  width="75px"><?php } ?></td>
                            <td><?php echo $registro->getCodigo(); ?></td>
                             <td><?php echo $registro->getCuentaContable(); ?></td>
                            <td><?php echo $registro->getDescripcion(); ?></td>
                            <td><?php if ($registro->getActivo()) { ?> <i class="fa fa-check"></i> <?php } ?></td>
                              <td><?php if ($registro->getVenta()) { ?> <i class="fa fa-check"></i> <?php } ?></td>
<!--                            <td><?php if ($registro->getReceta()) { ?> <i class="fa fa-check"></i> <?php } ?></td>-->
                            <td>
                               ...
                               <?php if (($registro->getDescripcion() <>'RECETA') && ($registro->getDescripcion() <>'COMBO')) { ?>
                                <br>
