...
<div class="kt-portlet kt-portlet--responsive-mobile">
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title kt-font-brand">
              DETALLE DE DÉBITO BANCARIO &nbsp;&nbsp;<strong> # <?php echo $muestra->getId(); ?>  </strong><small> &nbsp;&nbsp;&nbsp;
                     </small>
            </h3>
    ...
    <div class="kt-portlet__body">
          <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-danger nav-tabs-line-2x nav-tabs-line-right" role="tablist">
           <li class="nav-item">
                <a class="nav-link   active  " data-toggle="tab" href="#kt_portlet_<?php echo $muestra->getId(); ?>_demo_2_3_tab_content" role="tab" aria-selected="false">
                    <i class="fa fa-calendar-check-o" aria-hidden="true"></i>General
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link " data-toggle="tab" href="#kt_portlet_<?php echo $muestra->getId(); ?>_demo_3_3_tab_content" role="tab" aria-selected="false">
                    <i class="fa fa-bar-chart" aria-hidden="true"></i>Partida
                </a>
            </li>
          </ul>
                <div class="tab-content"    >
          <div class="tab-pane  active  " id="kt_portlet_<?php echo $muestra->getId(); ?>_demo_2_3_tab_content" role="tabpanel">
        ...
        <div class="row">
            ...
            <table class="table  table-bordered " >
                <tr>
                    ...
                    <td><?php echo $muestra->getMedioPago()  ?></td>
...
<?php echo $muestra->getBitacoraArchivo()->getNombreOriginal(); ?>
          ...
          <div class="tab-pane  " id="kt_portlet_<?php echo $muestra->getId(); ?>_demo_3_3_tab_content" role="tabpanel">
