...
<div class="kt-portlet kt-portlet--responsive-mobile">
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            <span class="kt-portlet__head-icon">
                <i class="flaticon-tabs kt-font-info"></i>
            </span>
            <h3 class="kt-portlet__head-title kt-font-success"> Débito/Transferencia  Bancaria
                <small>&nbsp;&nbsp;&nbsp; Ingresa una nueva débito. Visualiza por un rango de fechas  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</small>
            </h3>
        </div>
    ...
    <div class="kt-portlet__body">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-lg-5"><h3>Débito Bancario</h3></div>
