...
<?php if (!$UNA_LINEA) { ?>
    ...
    <table cellspacing="0" cellpadding="0" width="<?php echo $maximo; ?>">
        <tr>
            <td width="<?php echo $uno; ?>">&nbsp;</td>
            <td width="<?php echo $mitadPi; ?>"><span style="<?php echo $sT; ?>"><?php echo $valoresDefault['EMISOR']['NombreComercial']; ?> </span>
            ...
            <td width="<?php echo $mitadPi; ?>" style="text-align: left">&nbsp;&nbsp;<span style="<?php echo $sT; ?>">Autorización</span>
