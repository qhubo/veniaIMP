...
<table cellpadding="2">
    <tr>
        ...
        <th <?php if ($setear) { ?> width="120px" <?php } ?> style="<?php echo $sT; ?>;<?php if ($fondoEncabezado <> "#ffffff") { ?>   background-color:<?php echo $fondoEncabezado; ?>;   <?php } ?>text-align: center; <?php echo $boder; ?>"><strong>Total</strong></th>
    </tr>
    <?php $total = 0; ?>
    ...
    <tr>
        ...
        <!--    <th>Descuento</th>-->
        <th style="<?php echo $boderT; ?>;<?php echo $sT; ?>;  border-radius: 15px; <?php if ($fondoEncabezado <> "#ffffff") { ?>   background-color:<?php echo $fondoEncabezado; ?>;   <?php } ?>text-align: center; <?php echo $boder; ?>"><strong><?php echo Usuario::formato($total, "Q") ?></strong></th>
    </tr>
    <tr>
        <th colspan="4" style="<?php echo $boderT; ?><?php echo $sT; ?>;  <?php if ($fondoEncabezado <> "#ffffff") { ?>   background-color:<?php echo  $fondoEncabezado; ?>;   <?php } ?>text-align: right; <?php echo $boder; ?>"><strong><?php echo  $valoresDefault['GENERALES']['LEYENDA']; ?></strong>&nbsp;&nbsp;&nbsp;</th>


        <!--    <th>Descuento</th>-->
        <th style="<?php echo $boderT; ?>;<?php echo $sT; ?>;  border-radius: 15px; <?php if ($fondoEncabezado <> "#ffffff") { ?>   background-color:<?php echo $fondoEncabezado; ?>;   <?php } ?>text-align: center; <?php echo $boder; ?>"><strong><?php echo $valoresDefault['GENERALES']['CodigoMoneda']; ?></strong></th>
    </tr>
</table>