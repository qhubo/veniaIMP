...
<div class="kt-portlet kt-portlet--responsive-mobile">
    ...
    <div class="kt-portlet__body">
           <div class="row">
                ...
                <table class="kt-datatable table-bordered " id="html_table" width="100%">
                      <thead >
                <tr class="active">
                    <th  align="center"><span class="kt-font-success">Orden </span></th>
                    ...
                    <th  align="center"><span class="kt-font-success"> Pos </span></th>
                    <th  align="center"><span class="kt-font-success"> Movimiento Banco </span></th>
            ...
            <tbody>
                <?php foreach ($registros as $data) { ?>
                    <?php $lista = $data; ?>
                    <tr>
                        <td><?php echo $data->getOrden(); ?></td>
                        <td><?php echo $data->getCodigo(); ?></td>
                        <td><?php echo $data->getNombre() ?></td>
                        <td><?php echo $data->getCuentaContable(); ?></td>
                        <td style="text-align:center"> 
                            <div  style="text-align:center">
                                <?php if ($data->getPos()) { ?><li class="fa fa-check"></li> <?php } ?>
                            </div>
                        </td>

                            <td style="text-align:center">
                            <div  style="text-align:center">
                                <?php if ($data->getAplicaMovBanco()) { ?><li class="fa fa-check"></li> <?php } ?>
                            </div>
                            </td><!-- comment -->
                        <td style="text-align:center">
                            <div  style="text-align:center">
                                <?php if ($data->getActivo()) { ?><li class="fa fa-check"></li> <?php } ?>
                            </div>
                        </td>
                        <td>    
