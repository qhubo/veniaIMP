...
<div class="kt-portlet kt-portlet--responsive-mobile">
    ...
    <div class="kt-portlet__body">
        <div class="row">
            <div class="col-lg-4">Carga los saldos de tu partida inicial
                <br>
                <ul>
                    <li>Para saldos iniciales  de los bancos debe estar configurados cuentas contables previamente<li>
                </ul>
            </div> 
            <div class="col-lg-2">    <a  href="<?php echo url_for($modulo . '/index?ma2=1') ?>" class="btn btn-sm green btn-outline" >Ver&nbsp;todas&nbsp;las&nbsp;cuentas</a></div>
