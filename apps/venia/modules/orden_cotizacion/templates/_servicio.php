...
<table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inlin kt-datatable" id="html_table" width="100%">
    <thead >
        <tr class="active">
            ...
            <th  width="30px;" style="width:30px;"  align="center"><span class="kt-font-success"> Seleccionar </span></th>
        </tr>
    </thead>
    <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <font size="-1"><?php echo $registro->getNombre(); ?> </font>
                      ...
                      <td>
                     <a href="<?php echo url_for($modulo . '/servicio?id=' . $registro->getId()) ?>"  > 
                         <font size="-1"><?php echo Parametro::formato  ($registro->getPrecio()); ?> </font>
                     </a>
                     </td>
                <td>

                    <a href="<?php echo url_for($modulo . '/servicio?id=' . $registro->getId()) ?>"  > 
                        <font size="-1"><i class="  flaticon2-next"></i><font></font></font>
                    </a>
                </td>
            </tr>
        <?php } ?>
