...
<!--begin::Global Theme Bundle(used by all pages) -->
				...
				<!--end::Global Theme Bundle -->
                    ...
                    <!--begin::Page Scripts(used by this page) -->
                            ...
                            <script src="./assets/js/demo9/pages/crud/file-upload/uppy.js" type="text/javascript"></script>
                        <!--end::Page Scripts -->
            </body>
    <!-- end::Body -->
</html>
