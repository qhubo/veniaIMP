...
/**
 * OrdenProveedorPago form base class.
 *
 * @method OrdenProveedorPago getObject() Returns the current form's model object
 *
 * @package    plan
 * @subpackage form
 * @author     Via
 */
abstract class BaseOrdenProveedorPagoForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('orden_proveedor_pago[%s]');
