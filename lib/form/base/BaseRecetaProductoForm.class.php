...
/**
 * RecetaProducto form base class.
 *
 * @method RecetaProducto getObject() Returns the current form's model object
 *
 * @package    plan
 * @subpackage form
 * @author     Via
 */
abstract class BaseRecetaProductoForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'vence'             => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'vence'             => new sfValidatorBoolean(array('required' => false)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorPropelUnique(array('model' => 'RecetaProducto', 'column' => array('codigo_sku')))
    );

    $this->widgetSchema->setNameFormat('receta_producto[%s]');
