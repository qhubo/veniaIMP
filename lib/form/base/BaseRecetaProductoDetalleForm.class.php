...
/**
 * RecetaProductoDetalle form base class.
 *
 * @method RecetaProductoDetalle getObject() Returns the current form's model object
 *
 * @package    plan
 * @subpackage form
 * @author     Via
 */
abstract class BaseRecetaProductoDetalleForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('receta_producto_detalle[%s]');
