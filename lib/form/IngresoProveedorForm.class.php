<?php
class IngresoProveedorForm extends sfForm {
...
//             ->where("SUBSTR(CuentaErpContable.CuentaContable, length(cuenta_contable)-1, 2) <> '00'")
        ...
        $opciones['Local'] = 'Local';
           $opciones['Planilla'] = 'Planilla';
        $opciones['Internacional'] = 'Internacional';

        $tipo_regimen['Sobre las Utilidades']='Sobre las Utilidades';
        $tipo_regimen['Pequeño Contribuyente']='Pequeño Contribuyente';
        $tipo_regimen['Opcional Simplificado']='Opcional Simplificado';
        
                
          $this->setWidget('tipo_regimen', new sfWidgetFormChoice(array(
            "choices" => $tipo_regimen,
                ), array("class" => "form-control")));
        $this->setValidator('tipo_regimen', new sfValidatorString(array('required' => false)));
        
        
        $this->setWidget('nombre', new sfWidgetFormInputText(array(), array('class' => 'form-control ' , "placeholder" => "Nombre")));
        $this->setWidget('razon_social', new sfWidgetFormInputText(array(), array('class' => 'form-control ', "placeholder" => "Nombre de la razon social")));
        ...
        $this->setWidget('sitio_web', new sfWidgetFormInputText(array(), array('class' => 'form-control ', "placeholder" => "Página Web")));
        $this->setValidator('sitio_web', new sfValidatorString(array('required' => false)));
...
//       $criteriaTecnico->add(DepartamentoPeer::CODIGO, 'AAAA');
 ...
 $this->setWidget('telefono_contacto', new sfWidgetFormInputText(array("type"=>'number'), array('class' => 'form-control ',"placeholder" => "0000-0000")));
        ...
        $this->setValidator('razon_social', new sfValidatorString(array('required' => FALSE)));
...
//        );
 ...
 $this->setValidator('pos_pass', new sfValidatorString(array('required' => FALSE)));  
    ...
    $this->setWidget('RetieneIva', new sfWidgetFormInputCheckbox()); // new sfWidgetFormInputText(array(), array('class' => 'form-control','data-provide'=>'datepicker')));// cje
        $this->setValidator('RetieneIva', new sfValidatorString(array('required' => false)));
        
           $this->setWidget('ExentoIsr', new sfWidgetFormInputCheckbox()); // new sfWidgetFormInputText(array(), array('class' => 'form-control','data-provide'=>'datepicker')));// cje
        $this->setValidator('ExentoIsr', new sfValidatorString(array('required' => false)));
        
        
           $this->setWidget('RetineIsr', new sfWidgetFormInputCheckbox()); // new sfWidgetFormInputText(array(), array('class' => 'form-control','data-provide'=>'datepicker')));// cje
        $this->setValidator('RetineIsr', new sfValidatorString(array('required' => false)));
