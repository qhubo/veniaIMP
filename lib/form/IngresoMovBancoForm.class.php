...
class IngresoMovBancoForm extends sfForm {
    ...
    public function configure() {
        ...
        $mediopa = MedioPagoQuery::create()->filterByAplicaMovBanco(true)->filterByActivo(true)->orderByNombre()->find();
...
//        
        ...
        $this->setValidator('fecha_movimiento', new sfValidatorString(array('required' => true)));
                ...
                $this->setWidget('tienda', new sfWidgetFormChoice(array("choices" => $tipoT,), array("class" => "form-control")));
