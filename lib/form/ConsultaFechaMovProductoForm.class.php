...
class ConsultaFechaMovProductoForm extends sfForm {
    ...
    public function configure() {
        ...
        $consulta = "select usuario_id, usuario, o.estatus as estado from ingreso_producto_pro  o inner join usuario u on u.id =usuario_id  where o.empresa_id = '".$empresaId."' group by usuario_id,o.estatus";
