 ...
 * up to version 1767935369.
 * Generated on 2026-01-09 06:09:29 
 */
class PropelMigration_1767935369
{
...
ALTER TABLE `orden_cotizacion`
    ADD `transporte` VARCHAR(200) AFTER `pais_id`;
...
ALTER TABLE `orden_cotizacion` DROP `transporte`;
