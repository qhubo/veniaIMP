 ...
 * up to version 1772549573.
 * Generated on 2026-03-03 15:52:53 
 */
class PropelMigration_1772549573
{
...
CREATE TABLE `orden_cotizacion_empaque`
(
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `orden_cotizacion_id` INTEGER,
    `orden_empaque` INTEGER,
    PRIMARY KEY (`id`),
    INDEX `orden_cotizacion_empaque_FI_1` (`orden_cotizacion_id`),
    CONSTRAINT `orden_cotizacion_empaque_FK_1`
...
DROP TABLE IF EXISTS `orden_cotizacion_empaque`;
