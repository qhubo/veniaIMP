 ...
 * up to version 1768179354.
 * Generated on 2026-01-12 01:55:54 
 */
class PropelMigration_1768179354
{
...
ALTER TABLE `operacion_detalle`
    ADD `bulto_inicio` VARCHAR(10) AFTER `peso`,
    ADD `bulto_fin` VARCHAR(10) AFTER `bulto_inicio`;
...
ALTER TABLE `operacion_detalle` DROP `bulto_inicio`;

ALTER TABLE `operacion_detalle` DROP `bulto_fin`;
