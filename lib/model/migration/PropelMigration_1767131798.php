 ...
 * up to version 1767131798.
 * Generated on 2025-12-30 22:56:38 
 */
class PropelMigration_1767131798
{
...
ALTER TABLE `cliente`
    ADD `nombre_facturar` VARCHAR(260) AFTER `pais_id`;
...
ALTER TABLE `cliente` DROP `nombre_facturar`;
