 ...
 * up to version 1767409641.
 * Generated on 2026-01-03 04:07:21 
 */
class PropelMigration_1767409641
{
...
ALTER TABLE `operacion`
    ADD `transporte` VARCHAR(350) AFTER `empacado`;
...
ALTER TABLE `operacion` DROP `transporte`;
