 ...
 * up to version 1772422416.
 * Generated on 2026-03-02 04:33:36 
 */
class PropelMigration_1772422416
{
...
ALTER TABLE `nota_credito`
    ADD `json_retorna` VARCHAR(450) AFTER `documento_canje`;
...
ALTER TABLE `nota_credito` DROP `json_retorna`;
