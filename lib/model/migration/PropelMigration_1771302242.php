 ...
 * up to version 1771302242.
 * Generated on 2026-02-17 05:24:02 
 */
class PropelMigration_1771302242
{
...
ALTER TABLE `operacion`
    ADD `prefijo` VARCHAR(50) AFTER `acuerdo_pago`;
...
ALTER TABLE `operacion` DROP `prefijo`;

ALTER TABLE `orden_cotizacion` DROP `prefijo`;
