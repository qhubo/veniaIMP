...
abstract class BaseTasaCambio extends BaseObject implements Persistent
{
    ...
    public function setFecha($v)
    {
        ...
        if ($this->fecha !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TasaCambioPeer::FECHA;
            }
    ...
    public function setValor($v)
    {
        ...
        if ($this->valor !== $v) {
            $this->valor = $v;
            $this->modifiedColumns[] = TasaCambioPeer::VALOR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->valor = ($row[$startcol + 2] !== null) ? (double) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = TasaCambioPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TasaCambioPeer::FECHA)) {
            $modifiedColumns[':p' . $index++]  = '`FECHA`';
        }
        if ($this->isColumnModified(TasaCambioPeer::VALOR)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TasaCambioPeer::FECHA)) $criteria->add(TasaCambioPeer::FECHA, $this->fecha);
        if ($this->isColumnModified(TasaCambioPeer::VALOR)) $criteria->add(TasaCambioPeer::VALOR, $this->valor);
