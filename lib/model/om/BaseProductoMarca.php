...
/**
 * Base class that represents a row from the 'producto_marca' table.
 *
 *
 *
 ...
 */
abstract class BaseProductoMarca extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProductoMarcaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProductoMarcaPeer
     */
     ...
     * @return ProductoMarca The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ProductoMarcaPeer::ID;
        }
    ...
    public function setEmpresaId($v)
    {
        ...
        if ($this->empresa_id !== $v) {
            $this->empresa_id = $v;
            $this->modifiedColumns[] = ProductoMarcaPeer::EMPRESA_ID;
        }
    ...
    public function setProductoId($v)
    {
        ...
        if ($this->producto_id !== $v) {
            $this->producto_id = $v;
            $this->modifiedColumns[] = ProductoMarcaPeer::PRODUCTO_ID;
        }
    ...
    public function setMarca($v)
    {
        ...
        if ($this->marca !== $v) {
            $this->marca = $v;
            $this->modifiedColumns[] = ProductoMarcaPeer::MARCA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = ProductoMarcaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProductoMarca object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProductoMarcaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProductoMarcaQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseProductoMarca:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseProductoMarca:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseProductoMarca:save:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseProductoMarca:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                ProductoMarcaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProductoMarcaPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(ProductoMarcaPeer::EMPRESA_ID)) {
            $modifiedColumns[':p' . $index++]  = '`EMPRESA_ID`';
        }
        if ($this->isColumnModified(ProductoMarcaPeer::PRODUCTO_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PRODUCTO_ID`';
        }
        if ($this->isColumnModified(ProductoMarcaPeer::MARCA)) {
            $modifiedColumns[':p' . $index++]  = '`MARCA`';
        }

        $sql = sprintf(
            'INSERT INTO `producto_marca` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProductoMarcaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProductoMarcaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProductoMarca'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProductoMarca'][$this->getPrimaryKey()] = true;
        $keys = ProductoMarcaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductoMarcaPeer::ID)) $criteria->add(ProductoMarcaPeer::ID, $this->id);
        if ($this->isColumnModified(ProductoMarcaPeer::EMPRESA_ID)) $criteria->add(ProductoMarcaPeer::EMPRESA_ID, $this->empresa_id);
        if ($this->isColumnModified(ProductoMarcaPeer::PRODUCTO_ID)) $criteria->add(ProductoMarcaPeer::PRODUCTO_ID, $this->producto_id);
        if ($this->isColumnModified(ProductoMarcaPeer::MARCA)) $criteria->add(ProductoMarcaPeer::MARCA, $this->marca);
    ...
    {
        $criteria = new Criteria(ProductoMarcaPeer::DATABASE_NAME);
        $criteria->add(ProductoMarcaPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProductoMarca (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProductoMarca Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProductoMarcaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProductoMarcaPeer();
        }
    ...
    public function getEmpresa(PropelPDO $con = null)
    {
        if ($this->aEmpresa === null && ($this->empresa_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmpresa->addProductoMarcas($this);
             */
        }
    ...
    public function getProducto(PropelPDO $con = null)
    {
        if ($this->aProducto === null && ($this->producto_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProducto->addProductoMarcas($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProductoMarcaPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseProductoMarca:' . $name))
        {
