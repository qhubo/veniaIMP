...
abstract class BaseAgenda extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the no_sesion field.
     * @var        string
     */
    protected $no_sesion;
    ...
    /**
     * Get the [no_sesion] column value.
     *
     * @return string
     */
    public function getNoSesion()
    {
        return $this->no_sesion;
    }
    ...
    public function setFecha($v)
    {
        ...
        if ($this->fecha !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AgendaPeer::FECHA;
            }
    ...
    public function setHoraInicio($v)
    {
        ...
        if ($this->hora_inicio !== $v) {
            $this->hora_inicio = $v;
            $this->modifiedColumns[] = AgendaPeer::HORA_INICIO;
        }
    ...
    public function setHoraFin($v)
    {
        ...
        if ($this->hora_fin !== $v) {
            $this->hora_fin = $v;
            $this->modifiedColumns[] = AgendaPeer::HORA_FIN;
        }
    ...
    public function setEstatus($v)
    {
        ...
        if ($this->estatus !== $v) {
            $this->estatus = $v;
            $this->modifiedColumns[] = AgendaPeer::ESTATUS;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = AgendaPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = AgendaPeer::UPDATED_BY;
        }
    ...
    public function setClienteId($v)
    {
        ...
        if ($this->cliente_id !== $v) {
            $this->cliente_id = $v;
            $this->modifiedColumns[] = AgendaPeer::CLIENTE_ID;
        }
    ...
    public function setEmpresaId($v)
    {
        ...
        if ($this->empresa_id !== $v) {
            $this->empresa_id = $v;
            $this->modifiedColumns[] = AgendaPeer::EMPRESA_ID;
        }
    ...
    public function setTiendaId($v)
    {
        ...
        if ($this->tienda_id !== $v) {
            $this->tienda_id = $v;
            $this->modifiedColumns[] = AgendaPeer::TIENDA_ID;
        }
    ...
    public function setDoctor($v)
    {
        ...
        if ($this->doctor !== $v) {
            $this->doctor = $v;
            $this->modifiedColumns[] = AgendaPeer::DOCTOR;
        }
    ...
    /**
     * Set the value of [no_sesion] column.
     *
     * @param string $v new value
     * @return Agenda The current object (for fluent API support)
     */
    public function setNoSesion($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->no_sesion !== $v) {
            $this->no_sesion = $v;
            $this->modifiedColumns[] = AgendaPeer::NO_SESION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->estatus = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            ...
            $this->cliente_id = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
            ...
            $this->tienda_id = ($row[$startcol + 12] !== null) ? (int) $row[$startcol + 12] : null;
            $this->doctor = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->no_sesion = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->resetModified();
            ...
            return $startcol + 15; // 15 = AgendaPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AgendaPeer::FECHA)) {
            $modifiedColumns[':p' . $index++]  = '`FECHA`';
        }
        if ($this->isColumnModified(AgendaPeer::HORA_INICIO)) {
            $modifiedColumns[':p' . $index++]  = '`HORA_INICIO`';
        }
        if ($this->isColumnModified(AgendaPeer::HORA_FIN)) {
            $modifiedColumns[':p' . $index++]  = '`HORA_FIN`';
        }
        if ($this->isColumnModified(AgendaPeer::ESTATUS)) {
        ...
        if ($this->isColumnModified(AgendaPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_BY`';
        }
        if ($this->isColumnModified(AgendaPeer::UPDATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_BY`';
        }
        if ($this->isColumnModified(AgendaPeer::CLIENTE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`CLIENTE_ID`';
        }
        if ($this->isColumnModified(AgendaPeer::EMPRESA_ID)) {
            $modifiedColumns[':p' . $index++]  = '`EMPRESA_ID`';
        }
        if ($this->isColumnModified(AgendaPeer::OBSERVACIONES)) {
            $modifiedColumns[':p' . $index++]  = '`OBSERVACIONES`';
        }
        if ($this->isColumnModified(AgendaPeer::TIENDA_ID)) {
            $modifiedColumns[':p' . $index++]  = '`TIENDA_ID`';
        }
        if ($this->isColumnModified(AgendaPeer::DOCTOR)) {
            $modifiedColumns[':p' . $index++]  = '`DOCTOR`';
        }
        if ($this->isColumnModified(AgendaPeer::NO_SESION)) {
            $modifiedColumns[':p' . $index++]  = '`NO_SESION`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`DOCTOR`':
                        ...
                        break;
                    case '`NO_SESION`':
                        $stmt->bindValue($identifier, $this->no_sesion, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[9] => $this->getClienteId(),
            $keys[10] => $this->getEmpresaId(),
            $keys[11] => $this->getObservaciones(),
            $keys[12] => $this->getTiendaId(),
            $keys[13] => $this->getDoctor(),
            $keys[14] => $this->getNoSesion(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[9], $arr)) $this->setClienteId($arr[$keys[9]]);
        ...
        if (array_key_exists($keys[12], $arr)) $this->setTiendaId($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setDoctor($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setNoSesion($arr[$keys[14]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AgendaPeer::FECHA)) $criteria->add(AgendaPeer::FECHA, $this->fecha);
        if ($this->isColumnModified(AgendaPeer::HORA_INICIO)) $criteria->add(AgendaPeer::HORA_INICIO, $this->hora_inicio);
        if ($this->isColumnModified(AgendaPeer::HORA_FIN)) $criteria->add(AgendaPeer::HORA_FIN, $this->hora_fin);
        if ($this->isColumnModified(AgendaPeer::ESTATUS)) $criteria->add(AgendaPeer::ESTATUS, $this->estatus);
        ...
        if ($this->isColumnModified(AgendaPeer::CREATED_BY)) $criteria->add(AgendaPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(AgendaPeer::UPDATED_BY)) $criteria->add(AgendaPeer::UPDATED_BY, $this->updated_by);
        if ($this->isColumnModified(AgendaPeer::CLIENTE_ID)) $criteria->add(AgendaPeer::CLIENTE_ID, $this->cliente_id);
        if ($this->isColumnModified(AgendaPeer::EMPRESA_ID)) $criteria->add(AgendaPeer::EMPRESA_ID, $this->empresa_id);
        if ($this->isColumnModified(AgendaPeer::OBSERVACIONES)) $criteria->add(AgendaPeer::OBSERVACIONES, $this->observaciones);
        if ($this->isColumnModified(AgendaPeer::TIENDA_ID)) $criteria->add(AgendaPeer::TIENDA_ID, $this->tienda_id);
        if ($this->isColumnModified(AgendaPeer::DOCTOR)) $criteria->add(AgendaPeer::DOCTOR, $this->doctor);
        if ($this->isColumnModified(AgendaPeer::NO_SESION)) $criteria->add(AgendaPeer::NO_SESION, $this->no_sesion);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNoSesion($this->getNoSesion());
