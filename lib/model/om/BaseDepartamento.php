...
abstract class BaseDepartamento extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|RegionDetalle[] Collection to store aggregation of RegionDetalle objects.
     */
    protected $collRegionDetalles;
    protected $collRegionDetallesPartial;
     ...
     * @var		PropelObjectCollection
     */
    protected $regionDetallesScheduledForDeletion = null;
    ...
    public function setActivo($v)
    {
        ...
        if ($this->activo !== $v) {
            $this->activo = $v;
            $this->modifiedColumns[] = DepartamentoPeer::ACTIVO;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = DepartamentoPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = DepartamentoPeer::UPDATED_BY;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DepartamentoPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DepartamentoPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setObservaciones($v)
    {
        ...
        if ($this->observaciones !== $v) {
            ...
            $this->modifiedColumns[] = DepartamentoPeer::OBSERVACIONES;
        }
    ...
    public function setCodigoCargo($v)
    {
        ...
        if ($this->codigo_cargo !== $v) {
            $this->codigo_cargo = $v;
            $this->modifiedColumns[] = DepartamentoPeer::CODIGO_CARGO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->codigo_cargo = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->resetModified();
            ...
            return $startcol + 11; // 11 = DepartamentoPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($this->isModified() && !$this->isColumnModified(DepartamentoPeer::UPDATED_AT))
            {
            ...
            if ($isInsert) {
                ...
                // symfony_timestampable behavior
                if (!$this->isColumnModified(DepartamentoPeer::CREATED_AT))
                {
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->regionDetallesScheduledForDeletion !== null) {
                if (!$this->regionDetallesScheduledForDeletion->isEmpty()) {
                    foreach ($this->regionDetallesScheduledForDeletion as $regionDetalle) {
                        // need to save related object because we set the relation to null
                        $regionDetalle->save($con);
                    }
                    $this->regionDetallesScheduledForDeletion = null;
                }
            }

            if ($this->collRegionDetalles !== null) {
                foreach ($this->collRegionDetalles as $referrerFK) {
                    if (!$referrerFK->isDeleted()) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DepartamentoPeer::PAIS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PAIS_ID`';
        }
        if ($this->isColumnModified(DepartamentoPeer::CODIGO)) {
            $modifiedColumns[':p' . $index++]  = '`CODIGO`';
        }
        if ($this->isColumnModified(DepartamentoPeer::NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`NOMBRE`';
        }
        if ($this->isColumnModified(DepartamentoPeer::ACTIVO)) {
            $modifiedColumns[':p' . $index++]  = '`ACTIVO`';
        }
        if ($this->isColumnModified(DepartamentoPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_BY`';
        }
        if ($this->isColumnModified(DepartamentoPeer::UPDATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_BY`';
        }
        if ($this->isColumnModified(DepartamentoPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_AT`';
        }
        if ($this->isColumnModified(DepartamentoPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_AT`';
        }
        if ($this->isColumnModified(DepartamentoPeer::OBSERVACIONES)) {
            $modifiedColumns[':p' . $index++]  = '`OBSERVACIONES`';
        }
        if ($this->isColumnModified(DepartamentoPeer::CODIGO_CARGO)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collRegionDetalles) {
                $result['RegionDetalles'] = $this->collRegionDetalles->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[10], $arr)) $this->setCodigoCargo($arr[$keys[10]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DepartamentoPeer::ACTIVO)) $criteria->add(DepartamentoPeer::ACTIVO, $this->activo);
        if ($this->isColumnModified(DepartamentoPeer::CREATED_BY)) $criteria->add(DepartamentoPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(DepartamentoPeer::UPDATED_BY)) $criteria->add(DepartamentoPeer::UPDATED_BY, $this->updated_by);
        if ($this->isColumnModified(DepartamentoPeer::CREATED_AT)) $criteria->add(DepartamentoPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(DepartamentoPeer::UPDATED_AT)) $criteria->add(DepartamentoPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(DepartamentoPeer::OBSERVACIONES)) $criteria->add(DepartamentoPeer::OBSERVACIONES, $this->observaciones);
        if ($this->isColumnModified(DepartamentoPeer::CODIGO_CARGO)) $criteria->add(DepartamentoPeer::CODIGO_CARGO, $this->codigo_cargo);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getRegionDetalles() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addRegionDetalle($relObj->copy($deepCopy));
                }
            }
    ...
    public function initRelation($relationName)
    {
        ...
        if ('RegionDetalle' == $relationName) {
            $this->initRegionDetalles();
        }
    ...
    public function setEmpresas(PropelCollection $empresas, PropelPDO $con = null)
    {
        ...
        foreach ($this->empresasScheduledForDeletion as $empresaRemoved) {
            $empresaRemoved->setDepartamento(null);
        }
     ...
     * @return PropelObjectCollection|Empresa[] List of Empresa objects
     */
    public function getEmpresasJoinMunicipio($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = EmpresaQuery::create(null, $criteria);
    ...
    public function setProveedors(PropelCollection $proveedors, PropelPDO $con = null)
    {
        ...
        foreach ($this->proveedorsScheduledForDeletion as $proveedorRemoved) {
            $proveedorRemoved->setDepartamento(null);
        }
    ...
    public function setTiendas(PropelCollection $tiendas, PropelPDO $con = null)
    {
        ...
        foreach ($this->tiendasScheduledForDeletion as $tiendaRemoved) {
            $tiendaRemoved->setDepartamento(null);
        }
     ...
     * @return PropelObjectCollection|Tienda[] List of Tienda objects
     */
    public function getTiendasJoinMunicipio($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TiendaQuery::create(null, $criteria);
        $query->joinWith('Municipio', $join_behavior);
    ...
    public function setClientes(PropelCollection $clientes, PropelPDO $con = null)
    {
        ...
        foreach ($this->clientesScheduledForDeletion as $clienteRemoved) {
            $clienteRemoved->setDepartamento(null);
        }
     ...
     * @return PropelObjectCollection|Cliente[] List of Cliente objects
     */
    public function getClientesJoinVendedor($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ClienteQuery::create(null, $criteria);
    ...
    /**
     * Clears out the collRegionDetalles collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return void
     * @see        addRegionDetalles()
     */
    public function clearRegionDetalles()
    {
        $this->collRegionDetalles = null; // important to set this to null since that means it is uninitialized
        $this->collRegionDetallesPartial = null;
    }

    /**
     * reset is the collRegionDetalles collection loaded partially
     *
     * @return void
     */
    public function resetPartialRegionDetalles($v = true)
    {
        $this->collRegionDetallesPartial = $v;
    }

    /**
     * Initializes the collRegionDetalles collection.
     *
     * By default this just sets the collRegionDetalles collection to an empty array (like clearcollRegionDetalles());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initRegionDetalles($overrideExisting = true)
    {
        if (null !== $this->collRegionDetalles && !$overrideExisting) {
            return;
        }
        $this->collRegionDetalles = new PropelObjectCollection();
        $this->collRegionDetalles->setModel('RegionDetalle');
    }

    /**
     * Gets an array of RegionDetalle objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|RegionDetalle[] List of RegionDetalle objects
     * @throws PropelException
     */
    public function getRegionDetalles($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collRegionDetallesPartial && !$this->isNew();
        if (null === $this->collRegionDetalles || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collRegionDetalles) {
                // return empty collection
                $this->initRegionDetalles();
            } else {
                $collRegionDetalles = RegionDetalleQuery::create(null, $criteria)
                    ->filterByDepartamento($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collRegionDetallesPartial && count($collRegionDetalles)) {
                      $this->initRegionDetalles(false);

                      foreach($collRegionDetalles as $obj) {
                        if (false == $this->collRegionDetalles->contains($obj)) {
                          $this->collRegionDetalles->append($obj);
                        }
                      }

                      $this->collRegionDetallesPartial = true;
                    }

                    return $collRegionDetalles;
                }

                if($partial && $this->collRegionDetalles) {
                    foreach($this->collRegionDetalles as $obj) {
                        if($obj->isNew()) {
                            $collRegionDetalles[] = $obj;
                        }
                    }
                }

                $this->collRegionDetalles = $collRegionDetalles;
                $this->collRegionDetallesPartial = false;
            }
        }

        return $this->collRegionDetalles;
    }

    /**
     * Sets a collection of RegionDetalle objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $regionDetalles A Propel collection.
     * @param PropelPDO $con Optional connection object
     */
    public function setRegionDetalles(PropelCollection $regionDetalles, PropelPDO $con = null)
    {
        $this->regionDetallesScheduledForDeletion = $this->getRegionDetalles(new Criteria(), $con)->diff($regionDetalles);

        foreach ($this->regionDetallesScheduledForDeletion as $regionDetalleRemoved) {
            $regionDetalleRemoved->setDepartamento(null);
        }

        $this->collRegionDetalles = null;
        foreach ($regionDetalles as $regionDetalle) {
            $this->addRegionDetalle($regionDetalle);
        }

        $this->collRegionDetalles = $regionDetalles;
        $this->collRegionDetallesPartial = false;
    }

    /**
     * Returns the number of related RegionDetalle objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related RegionDetalle objects.
     * @throws PropelException
     */
    public function countRegionDetalles(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collRegionDetallesPartial && !$this->isNew();
        if (null === $this->collRegionDetalles || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collRegionDetalles) {
                ...
                if($partial && !$criteria) {
                    return count($this->getRegionDetalles());
                }
                $query = RegionDetalleQuery::create(null, $criteria);
                if ($distinct) {
                    $query->distinct();
                }
            ...
            return count($this->collRegionDetalles);
        }
    }

    /**
     * Method called to associate a RegionDetalle object to this object
     * through the RegionDetalle foreign key attribute.
     *
     * @param    RegionDetalle $l RegionDetalle
     * @return Departamento The current object (for fluent API support)
     */
    public function addRegionDetalle(RegionDetalle $l)
    {
        if ($this->collRegionDetalles === null) {
            $this->initRegionDetalles();
            $this->collRegionDetallesPartial = true;
        }
        if (!$this->collRegionDetalles->contains($l)) { // only add it if the **same** object is not already associated
            $this->doAddRegionDetalle($l);
        }
    ...
    /**
     * @param	RegionDetalle $regionDetalle The regionDetalle object to add.
     */
    protected function doAddRegionDetalle($regionDetalle)
    {
        $this->collRegionDetalles[]= $regionDetalle;
        $regionDetalle->setDepartamento($this);
    }

    /**
     * @param	RegionDetalle $regionDetalle The regionDetalle object to remove.
     */
    public function removeRegionDetalle($regionDetalle)
    {
        if ($this->getRegionDetalles()->contains($regionDetalle)) {
            $this->collRegionDetalles->remove($this->collRegionDetalles->search($regionDetalle));
            if (null === $this->regionDetallesScheduledForDeletion) {
                $this->regionDetallesScheduledForDeletion = clone $this->collRegionDetalles;
                $this->regionDetallesScheduledForDeletion->clear();
            }
            $this->regionDetallesScheduledForDeletion[]= $regionDetalle;
            $regionDetalle->setDepartamento(null);
        }
    }
     ...
     * Otherwise if this Departamento is new, it will return
     * an empty collection; or if this Departamento has previously
     * been saved, it will retrieve related RegionDetalles from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Departamento.
     ...
     * @return PropelObjectCollection|RegionDetalle[] List of RegionDetalle objects
     */
    public function getRegionDetallesJoinRegion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RegionDetalleQuery::create(null, $criteria);
        $query->joinWith('Region', $join_behavior);

        return $this->getRegionDetalles($query, $con);
    }
    ...
    public function setFormularioDatoss(PropelCollection $formularioDatoss, PropelPDO $con = null)
    {
        ...
        foreach ($this->formularioDatossScheduledForDeletion as $formularioDatosRemoved) {
            $formularioDatosRemoved->setDepartamento(null);
        }
    ...
    protected function doAddFormularioDatos($formularioDatos)
    {
        ...
        $formularioDatos->setDepartamento($this);
    }
    ...
    public function removeFormularioDatos($formularioDatos)
    {
        if ($this->getFormularioDatoss()->contains($formularioDatos)) {
            ...
            $formularioDatos->setDepartamento(null);
        }
    }
     ...
     * @return PropelObjectCollection|FormularioDatos[] List of FormularioDatos objects
     */
    public function getFormularioDatossJoinMunicipio($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = FormularioDatosQuery::create(null, $criteria);
        $query->joinWith('Municipio', $join_behavior);
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep) {
            ...
            if ($this->collRegionDetalles) {
                foreach ($this->collRegionDetalles as $o) {
                    $o->clearAllReferences($deep);
                }
            }
        ...
        $this->collClientes = null;
        if ($this->collRegionDetalles instanceof PropelCollection) {
            $this->collRegionDetalles->clearIterator();
        }
        $this->collRegionDetalles = null;
