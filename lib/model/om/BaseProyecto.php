...
abstract class BaseProyecto extends BaseObject implements Persistent
{
    ...
    public function setActivo($v)
    {
        ...
        if ($this->activo !== $v) {
            $this->activo = $v;
            $this->modifiedColumns[] = ProyectoPeer::ACTIVO;
        }
    ...
    public function setObservaciones($v)
    {
        ...
        if ($this->observaciones !== $v) {
            ...
            $this->modifiedColumns[] = ProyectoPeer::OBSERVACIONES;
        }
    ...
    public function setEmpresaId($v)
    {
        ...
        if ($this->empresa_id !== $v) {
            $this->empresa_id = $v;
            $this->modifiedColumns[] = ProyectoPeer::EMPRESA_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = ProyectoPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProyectoPeer::ACTIVO)) {
        ...
        if ($this->isColumnModified(ProyectoPeer::OBSERVACIONES)) {
            $modifiedColumns[':p' . $index++]  = '`OBSERVACIONES`';
        }
        if ($this->isColumnModified(ProyectoPeer::EMPRESA_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProyectoPeer::ACTIVO)) $criteria->add(ProyectoPeer::ACTIVO, $this->activo);
        ...
        if ($this->isColumnModified(ProyectoPeer::OBSERVACIONES)) $criteria->add(ProyectoPeer::OBSERVACIONES, $this->observaciones);
        if ($this->isColumnModified(ProyectoPeer::EMPRESA_ID)) $criteria->add(ProyectoPeer::EMPRESA_ID, $this->empresa_id);
    ...
    public function getEmpresa(PropelPDO $con = null)
    {
        if ($this->aEmpresa === null && ($this->empresa_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmpresa->addProyectos($this);
             */
        }
     ...
     * If this Proyecto is new, it will return
