...
abstract class BaseMenuSeguridad extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the sub_menu field.
    ...
    /**
     * Sets the value of the [sub_menu] column.
    ...
    public function setSubMenu($v)
    {
        ...
        if ($this->sub_menu !== $v) {
            $this->sub_menu = $v;
            $this->modifiedColumns[] = MenuSeguridadPeer::SUB_MENU;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->sub_menu = ($row[$startcol + 8] !== null) ? (boolean) $row[$startcol + 8] : null;
            $this->resetModified();
            ...
            return $startcol + 9; // 9 = MenuSeguridadPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MenuSeguridadPeer::SUB_MENU)) {
            $modifiedColumns[':p' . $index++]  = '`SUB_MENU`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`ORDEN`':
                        ...
                        break;
                    case '`SUB_MENU`':
                        $stmt->bindValue($identifier, (int) $this->sub_menu, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[8], $arr)) $this->setSubMenu($arr[$keys[8]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuSeguridadPeer::SUB_MENU)) $criteria->add(MenuSeguridadPeer::SUB_MENU, $this->sub_menu);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setSubMenu($this->getSubMenu());
