...
/**
 * Base class that represents a row from the 'region_detalle' table.
 *
 *
 *
 ...
 */
abstract class BaseRegionDetalle extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RegionDetallePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RegionDetallePeer
     */
     ...
     * @return RegionDetalle The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RegionDetallePeer::ID;
        }
    ...
    public function setDepartamentoId($v)
    {
        ...
        if ($this->departamento_id !== $v) {
            ...
            $this->modifiedColumns[] = RegionDetallePeer::DEPARTAMENTO_ID;
        }
    ...
    public function setRegionId($v)
    {
        ...
        if ($this->region_id !== $v) {
            $this->region_id = $v;
            $this->modifiedColumns[] = RegionDetallePeer::REGION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = RegionDetallePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RegionDetalle object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RegionDetallePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RegionDetalleQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseRegionDetalle:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseRegionDetalle:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseRegionDetalle:save:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseRegionDetalle:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                RegionDetallePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RegionDetallePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(RegionDetallePeer::DEPARTAMENTO_ID)) {
            $modifiedColumns[':p' . $index++]  = '`DEPARTAMENTO_ID`';
        }
        if ($this->isColumnModified(RegionDetallePeer::REGION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`REGION_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `region_detalle` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RegionDetallePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RegionDetallePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['RegionDetalle'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RegionDetalle'][$this->getPrimaryKey()] = true;
        $keys = RegionDetallePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RegionDetallePeer::ID)) $criteria->add(RegionDetallePeer::ID, $this->id);
        if ($this->isColumnModified(RegionDetallePeer::DEPARTAMENTO_ID)) $criteria->add(RegionDetallePeer::DEPARTAMENTO_ID, $this->departamento_id);
        if ($this->isColumnModified(RegionDetallePeer::REGION_ID)) $criteria->add(RegionDetallePeer::REGION_ID, $this->region_id);
    ...
    {
        $criteria = new Criteria(RegionDetallePeer::DATABASE_NAME);
        $criteria->add(RegionDetallePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of RegionDetalle (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RegionDetalle Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RegionDetallePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RegionDetallePeer();
        }
    ...
    public function getDepartamento(PropelPDO $con = null)
    {
        if ($this->aDepartamento === null && ($this->departamento_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDepartamento->addRegionDetalles($this);
             */
        }
    ...
    public function getRegion(PropelPDO $con = null)
    {
        if ($this->aRegion === null && ($this->region_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRegion->addRegionDetalles($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(RegionDetallePeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseRegionDetalle:' . $name))
        {
