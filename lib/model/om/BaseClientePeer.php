...
abstract class BaseClientePeer
{
    ...
    const ARCHIVO = 'cliente.ARCHIVO';

    /** the column name for the TIPO_CLIENTE field */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ClientePeer::VENDEDOR_ID);
            $criteria->addSelectColumn(ClientePeer::ARCHIVO);
            $criteria->addSelectColumn(ClientePeer::TIPO_CLIENTE);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.TIPO_CLIENTE');
        }
    }
    ...
    public static function doCountJoinVendedor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ClientePeer::VENDEDOR_ID, VendedorPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Cliente objects pre-filled with their Vendedor objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Cliente objects.
    ...
    public static function doSelectJoinVendedor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Cliente) to $obj2 (Vendedor)
                $obj2->addCliente($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key6 !== null) {
                ...
                // Add the $obj1 (Cliente) to the collection in $obj6 (Vendedor)
                $obj6->addCliente($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptEmpresa(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = ClientePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Cliente) to the collection in $obj5 (Vendedor)
                $obj5->addCliente($obj1);
    ...
    /**
     * Selects a collection of Cliente objects pre-filled with all related objects except Vendedor.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
