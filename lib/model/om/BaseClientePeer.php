...
abstract class BaseClientePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'EmpresaId', 'Codigo', 'Nombre', 'PequenoContribuye', 'RegimenIsr', 'Direccion', 'Telefono', 'CorreoElectronico', 'Observaciones', 'Nit', 'DiasCredito', 'TipoReferencia', 'Activo', 'TieneCredito', 'AvenidaCalle', 'Zona', 'DepartamentoId', 'MunicipioId', 'Contacto', 'CorreoContacto', 'Imagen', 'TelefonoContacto', 'Tipificacion', 'Fecha', 'TipoProducto', 'PorcentajeNegociado', 'LimiteCredito', 'PaisId', ),
