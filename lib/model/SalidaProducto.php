...
/**
 * Skeleton subclass for representing a row from the 'salida_producto' table.
 *
 *
 *
 ...
 */
class SalidaProducto extends BaseSalidaProducto
{
    
       public function save(PropelPDO $con = null) {
        $empresaId = UsuarioQuery::getEmpresaSeleccionada('SalidaProducto');
