 ...
 */
class CuentaErpPeer extends BaseCuentaErpPeer {
...
//                        echo " ------------- ";
            ...
            if ($contador > $lineaInicial) {
                ...
                if (array_key_exists($colGRUPO, $registro)) {
                    $GRUPO = trim(utf8_encode($registro[$colGRUPO]));
                } else {
                    $valido = false;
                    $pendientes[] = 'GRUPO';
                }
                ...
                if (array_key_exists($colCUENTA, $registro)) {
                    $CUENTA = trim(utf8_encode($registro[$colCUENTA]));
                } else {
                    $valido = false;
                    $pendientes[] = 'CUENTA';
                }
                if (array_key_exists($colNOMBRE, $registro)) {
                    $NOMBRE = trim(utf8_encode($registro[$colNOMBRE]));
                } else {
                    $valido = false;
                    $pendientes[] = 'NOMBRE';
                }
