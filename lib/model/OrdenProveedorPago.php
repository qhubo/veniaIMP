...
/**
 * Skeleton subclass for representing a row from the 'orden_proveedor_pago' table.
 *
 *
 *
 ...
 */
class OrdenProveedorPago extends BaseOrdenProveedorPago
{
          public function save(PropelPDO $con = null) {
        $empresaId = UsuarioQuery::getEmpresaSeleccionada('OrdenProveedorPago');
