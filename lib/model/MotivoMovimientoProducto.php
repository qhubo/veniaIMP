...
/**
 * Skeleton subclass for representing a row from the 'motivo_movimiento_producto' table.
 *
 *
 *
 ...
 */
class MotivoMovimientoProducto extends BaseMotivoMovimientoProducto
{
    
         public function save(PropelPDO $con = null) {
        $empresaId = UsuarioQuery::getEmpresaSeleccionada('MotivoMovimientoProducto');
