...
/**
 * Skeleton subclass for representing a row from the 'marca_producto' table.
 *
 *
 *
 ...
 */
class MarcaProducto extends BaseMarcaProducto
{
          public function save(PropelPDO $con = null) {
        $empresaId = UsuarioQuery::getEmpresaSeleccionada('MarcaProducto');
