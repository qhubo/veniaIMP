...
abstract class BaseOperacionPagoFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'operacion_pago_padre_no' => new sfWidgetFormFilterInput(),
    ));
    ...
    $this->setValidators(array(
      ...
      'operacion_pago_padre_no' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ));
  ...
  public function getFields()
  {
    return array(
      ...
      'comision'                => 'Number',
      'vuelto'                  => 'Number',
      'operacion_pago_padre_no' => 'Number',
    );
  }
}
