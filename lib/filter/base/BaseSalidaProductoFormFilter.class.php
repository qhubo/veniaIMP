...
/**
 * SalidaProducto filter form base class.
 *
 * @package    plan
 * @subpackage filter
 * @author     Via
 */
abstract class BaseSalidaProductoFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'bodega_destino'        => new sfValidatorPass(array('required' => false)),
      'empresa_id'            => new sfValidatorPropelChoice(array('required' => false, 'model' => 'Empresa', 'column' => 'id')),
    ));

    $this->widgetSchema->setNameFormat('salida_producto_filters[%s]');
