...
/**
 * ProductoExistencia filter form base class.
 *
 * @package    plan
 * @subpackage filter
 * @author     Via
 */
abstract class BaseProductoExistenciaFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'diferencia'  => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'transito'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ));

    $this->widgetSchema->setNameFormat('producto_existencia_filters[%s]');
