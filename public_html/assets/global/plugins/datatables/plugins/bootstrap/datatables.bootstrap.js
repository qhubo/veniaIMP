...
$.extend(true, $.fn.dataTable.defaults, {
    "dom": "<'row'<'col-lg-2 col-lg-2'l><'col-lg-8 col-sm-8'f>r><'table-scrollable't><'row'<'col-lg-5 col-lg-5'i><'col-lg-7 col-lg-7'p>>", // default layout with horizobtal scrollable datatable
    //"dom": "<'row'<'col-lg-6 col-sm-12'l><'col-lg-6 col-sm-12'f>r>t<'row'<'col-lg-5 col-sm-12'i><'col-lg-7 col-sm-12'p>>", // datatable layout without  horizobtal scroll(used when bootstrap dropdowns used in the datatable cells)
    "language": {
        "lengthMenu": " _MENU_ Registros ",
        "emptyTable":     "Listado Vacio",
